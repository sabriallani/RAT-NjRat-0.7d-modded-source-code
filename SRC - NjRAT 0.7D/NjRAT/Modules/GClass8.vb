...
Public NotInheritable Class GClass8
    ...
    ' Methods
    Public Sub New()
        Me.fonty = New Font("arial", 8.0!, FontStyle.Bold)
    ...
    Private Sub lam__4(ByVal a0 As Object, ByVal a1 As EventArgs)
        Try
            Me.wrk()
    ...
    Public Property T As Timer
        ...
        Set(ByVal WithEventsValue As Timer)
            Dim handler As EventHandler = New EventHandler(AddressOf Me.lam__4)
